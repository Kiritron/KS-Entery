...
public class CefSettings {
     ...
     */
    public boolean command_line_args_disabled = true;
     ...
     */
    public String cache_path = GetPathOfAPP.GetPathWithSep() + "cache";
     ...
     */
    public String user_agent = NAME_APP_USER_AGENT;
     ...
     */
    public String product_version = VER_APP_USER_AGENT;
     ...
     * switch.
     */
    public String resources_dir_path = GetPathOfAPP.GetPathWithSep() + "res";
     ...
     * command-line switch.
     */
    public String locales_dir_path = GetPathOfAPP.GetPathWithSep() + "lang";
     ...
     */
    public ColorType background_color = new ColorType(255,48,48,48);
