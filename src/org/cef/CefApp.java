...
public class CefApp extends CefAppHandlerAdapter {
        ...
        try {
            Runnable r = new Runnable() {
                ...
                public void run() {
                    ...
                    toConsole.print(genLogMessage.gen((byte) 1, false, "initialize on " + Thread.currentThread()
    ...
    private final void shutdown() {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                toConsole.print(genLogMessage.gen((byte) 1, false, "shutdown on " + Thread.currentThread()));
